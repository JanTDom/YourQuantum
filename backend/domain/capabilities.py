...
def get_capabilities_registry() -> list[CapabilityRecord]:
    ...
    return [
        ...
        CapabilityRecord(
            id="qcore-noise-sim",
            name="Noise Model Simulator (Kraus Channels)",
            category="Quantum Core",
            status=CapabilityStatus.PLANNED,
            description="Depolarizing and thermal relaxation noise simulation for NISQ circuits.",
            is_available=False,
        ),
        CapabilityRecord(
            id="qcore-qpu-hardware",
            name="Physical QPU Connectivity (IBM/Braket)",
            category="Quantum Core",
            status=CapabilityStatus.PLANNED,
            description="Submission to real superconducting and neutral-atom hardware.",
            is_available=False,
        ),
