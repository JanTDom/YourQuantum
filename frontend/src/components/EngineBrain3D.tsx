...
export const BRAIN_LOBES: Record<BrainLobeId, LobeInfo> = {
  FRONTAL_INTAKE: {
    id: "FRONTAL_INTAKE",
    name: "Płat Czołowy: Bramka Jakości & Stopnie Swobody",
    subtitle: "Rygorystyczna Formalizacja Algebraiczna",
    color: "#fbbf24",
    glowHex: 0xfbbf24,
    badge: "Etap 1: Intake & Gate",
    cameraPos: [0, 4, 19],
    targetPos: [0, 0.5, 3],
    explanation:
      "Likwidacja błędu 'Garbage In, Garbage Out'. System odrzuca puste ogólniki, wymusza precyzję, sprawdza stopnie swobody i buduje ścisły model algebraiczny zanim uruchomi solwery.",
    bulletPoints: [
      "Zero tolerancji dla ogólników: wymuszenie precyzyjnych alternatyw i liczb.",
      "Identyfikacja sprzecznych celów, relacji logicznych i ukrytych kompromisów.",
      "Budowa kanonicznego Problem IR — matematycznej bazy dylematu.",
    ],
  },
  LEFT_CONSTRAINTS: {
    id: "LEFT_CONSTRAINTS",
    name: "Płat Lewy: Filtr Ograniczeń & Dekompozycja",
    subtitle: "Dyskretny Solver Dokładny (CP-SAT / Benders)",
    color: "#38bdf8",
    glowHex: 0x38bdf8,
    ...
    targetPos: [-4.5, 0, 0],
    explanation:
      "Bezwzględny strażnik Twoich granic. Każdy wariant, który przekracza budżet lub łamie twarde zasady, zostaje odcięty cięciem kombinatorycznym. Żaden czat AI nie daje takiej gwarancji.",
    bulletPoints: [
      "100% twarda gwarancja: warunek złamany = wariant odrzucony (residuum 0.0000).",
      "Dekompozycja wieloskalowa: łączenie decyzji strategicznych z alokacją zasobów.",
      "Odporność na skalę: obsługa tysięcy powiązań bez utraty rygoru logicznego.",
    ],
  },
  RIGHT_QUANTUM: {
    id: "RIGHT_QUANTUM",
    name: "Płat Prawy: Warm-Started QAOA",
    subtitle: "Interferencja Amplitud & Przestrzeń Stanów 2^N",
    color: "#c084fc",
    glowHex: 0xc084fc,
    ...
    targetPos: [4.5, 0, 0],
    explanation:
      "Eksploracja przestrzeni stanów za pomocą interferencji kwantowej. Zamiast ślepego losowania, wektor stanu zostaje ukierunkowany w przestrzeni Hilberta, a fale prawdopodobieństwa wygaszają złe opcje.",
    bulletPoints: [
      "Warm-Starting: ukierunkowanie wektora stanu w oparciu o geometrię optimum.",
      "Konstruktywna interferencja skupiająca prawdopodobieństwo w stanie podstawowym.",
      "Analiza pełnej topologii energetycznej: identyfikacja strategii alternatywnych.",
    ],
  },
  CORE_OPTIMUM: {
    id: "CORE_OPTIMUM",
    name: "Rdzeń Centralny: Certyfikat & Test Szoku",
    subtitle: "Paszport SHA-256 & Odporność na Wstrząsy",
    color: "#ffffff",
    glowHex: 0xffffff,
    badge: "Etap 4: Dowód & Certyfikacja",
    cameraPos: [0, 7, 13],
    targetPos: [0, 0, 0],
    explanation:
      "Matematyczny paszport decyzji. Rozwiązanie otrzymuje certyfikat zerowego residuum błędu, dowód luki optymalności oraz przechodzi test szoku rynkowego (Stress-Test ±25%).",
    bulletPoints: [
      "Kryptograficzny paszport weryfikacji z unikalnym podpisem SHA-256.",
      "Matematycznie dowiedziona granica luki optymalności (Dual Bound Gap).",
      "Test odporności na szok: gwarancja stabilności decyzji przy zmianach rynkowych.",
    ],
  },
}
