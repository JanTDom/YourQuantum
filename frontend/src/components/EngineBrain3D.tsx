...
export const BRAIN_LOBES: Record<BrainLobeId, LobeInfo> = {
  FRONTAL_INTAKE: {
    id: "FRONTAL_INTAKE",
    name: "Kora Przedczołowa: Pamięć Robocza & Homeostaza",
    subtitle: "Global Workspace, Budżet Metaboliczny & Bramka Jakości",
    color: "#fbbf24",
    glowHex: 0xfbbf24,
    badge: "Kognitywna Pamięć Robocza",
    cameraPos: [0, 4, 19],
    targetPos: [0, 0.5, 3],
    explanation:
    ...
    bulletPoints: [
      ...
      "Budowa kanonicznego Problem IR — ścisłego kontraktu matematycznego.",
    ],
  },
  LEFT_CONSTRAINTS: {
    id: "LEFT_CONSTRAINTS",
    name: "Płat Lewy: Hipokamp & Filtr Ograniczeń",
    subtitle: "Pamięć Epizodyczna (Recall) & Solver Dokładny CP-SAT",
    color: "#38bdf8",
    glowHex: 0x38bdf8,
    badge: "Epizodyczny Hipokamp & CP-SAT",
    cameraPos: [-14, 4, 14],
    targetPos: [-4.5, 0, 0],
    explanation:
      "Hippocampal Subsystem przechowujący trwałe ślady pamięciowe (cognitive_traces). Przywołuje skuteczne wzorce historyczne, a dyskretny solver CP-SAT bezwzględnie egzekwuje każde twarde ograniczenie.",
    bulletPoints: [
      "Pamięć epizodyczna: asocjacyjny recall udanych formulacji po sygnaturze problemu.",
      "100% twarda gwarancja: warunek złamany = wariant odrzucony (residuum 0.0000).",
      "Dekompozycja kombinatoryczna Bendersa i cięcia dopuszczalności.",
    ],
  },
  RIGHT_QUANTUM: {
    id: "RIGHT_QUANTUM",
    ...
    bulletPoints: [
      "Warm-Starting: ukierunkowanie wektora stanu w oparciu o geometrię relaksacji.",
  ...
  CORE_OPTIMUM: {
    id: "CORE_OPTIMUM",
    name: "Rdzeń Centralny: Active Inference & Certyfikat",
    subtitle: "Pętla Minimalizacji Błędu (Friston) & Paszport SHA-256",
    color: "#ffffff",
    glowHex: 0xffffff,
    badge: "Active Inference & Certyfikat",
    cameraPos: [0, 7, 13],
    targetPos: [0, 0, 0],
    explanation:
      "Zasada Wolnej Energii Karla Fristona. Sygnał błędu z weryfikatora traktowany jest jako Błąd Predykcji i korygowany w pętli autorefleksji. Zweryfikowane optimum otrzymuje kryptograficzny paszport SHA-256.",
    bulletPoints: [
      "Active Inference: pętla autorefleksji minimalizująca błąd predykcji przed publikacją.",
      "Kryptograficzny paszport weryfikacji z unikalnym podpisem SHA-256.",
      "Matematycznie dowiedziona granica luki optymalności (Dual Bound Gap) i Stress-Test.",
    ],
  },
}
